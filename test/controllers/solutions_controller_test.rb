...
class SolutionsControllerTest < ActionController::TestCase
  ...
  test "should create solution" do
    assert_difference('Solution.count') do
      post :create, solution: { chapter_id: @solution.chapter_id, description: @solution.description, order: @solution.order }
    end
  ...
  test "should update solution" do
    patch :update, id: @solution, solution: { chapter_id: @solution.chapter_id, description: @solution.description, order: @solution.order }
    assert_redirected_to solution_path(assigns(:solution))
  end
